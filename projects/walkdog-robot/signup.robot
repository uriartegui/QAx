...
Deve poder cadastrar um novo dog walker
    ${name}                   Set Variable    Guilherme Uriarte
    ${email}                  Set Variable    guiuriarte@gmail.com
    ${cpf}                    Set Variable    10336191910
    ${cep}                    Set Variable    88101290
    ${addressStreet}          Set Variable    Rua Irmãos Vieira
    ${addressDistrict}        Set Variable    Campinas
    ${addressCityUf}          Set Variable    São José/SC
    ${addressNumber}          Set Variable    300
    ${addressDetails}         Set Variable    Apto 207
